...
public:
    ...
    static FVector GetNewVelocityFromAcceleration(FVector velocity, float deltaTime, FVector acceleration, float maxVelocity);
    static FRotator GetNewOrientationFromVelocity(FVector velocity);
};
